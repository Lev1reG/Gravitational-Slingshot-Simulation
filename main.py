...
class Planet:
    def __init__(self, x, y, MASS, PLANET_NAME, PLANET_RADIUS):
        ...
        self.MAX_ASTEROIDS = rd.randint(1, 5)
    ...
    def simulate(self, MAX_ASTEROID_MASS, MIN_ASTEROID_VEL, MAX_ASTEROID_VEL):
        ...
        while running:
            ...
            for obj in objects[:]:
                ...
                collided = math.sqrt((obj.x - planet.x)**2 + (obj.y - planet.y)**2) <= self.PLANET_RADIUS
...
class Asteroid:
    def __init__(self, MAX_MASS):
        ...
        self.ASTEROID_RADIUS = rd.randint(10, 50)
    ...
    def draw(self):
        ASTEROID = pygame.transform.scale(
            pygame.image.load("asteroid.png"), (self.ASTEROID_RADIUS, self.ASTEROID_RADIUS)
        )
